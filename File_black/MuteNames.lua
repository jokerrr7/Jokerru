...
if bot_data:get(XBOT.."MARTEN:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
bot_data:sadd(XBOT.."MARTEN:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and bot_data:get(XBOT.."MARTEN:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
XBOTName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if XBOTName then 
XBOTNames = bot_data:smembers(XBOT.."MARTEN:Mute:Names"..msg.chat_id_) or ""
if XBOTNames and XBOTNames[1] then 
for i=1,#XBOTNames do 
if XBOTName:match("(.*)("..XBOTNames[i]..")(.*)") then 
...
bot_data:set(XBOT.."MARTEN:Lock:MuteNames"..msg.chat_id_,true)
end
...
bot_data:del(XBOT.."MARTEN:Lock:MuteNames"..msg.chat_id_)
end
end
end
