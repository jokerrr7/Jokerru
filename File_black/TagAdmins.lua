...
if bot_data:get(XBOT.."MARTEN:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
send_X(msg.chat_id_, msg.id_, 1, '⌯︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
bot_data:setex(XBOT..'MARTEN:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
